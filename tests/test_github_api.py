...
def test_check_repo_custom_property_success():
    ...
    assert check_repo_custom_property(template_owner, template_name, custom_properties) is True
...
def test_check_repo_custom_property_failure():
    ...
    assert check_repo_custom_property(template_owner, template_name, custom_properties) is False
